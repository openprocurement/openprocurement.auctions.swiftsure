...
class AuctionDocumentResource(AuctionDocumentResource):
    ...
    def collection_post(self):
        ...
        if (
            ...
            and self.request.validated['auction_status'] != 'active.tendering'
            or self.request.authenticated_role == 'auction'
            and self.request.validated['auction_status'] not in ['active.auction', 'active.qualification']
        ):
    ...
    def put(self):
        ...
        if (
            ...
            and self.request.validated['auction_status'] != 'active.tendering'
            or self.request.authenticated_role == 'auction'
            and self.request.validated['auction_status']
            not in ['active.auction', 'active.qualification']
        ):
            self.request.errors.add(
